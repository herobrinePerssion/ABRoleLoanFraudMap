...
const cases = ref([
  {
    title: '案例一：上海受害者朱某被骗78万元',
    description: '朱某在抖音上添加“军官贷”客服，被骗提供征信后陆续贷款十几笔，最严重一笔贷款达15万元，最终债务高达78万元。',
    region: '上海'
  },
  {
    title: '案例二：安徽大学生被以“提高信用”为由骗贷30万',
    description: '犯罪团伙以代办“公务员贷”为由，通过电话诱导大学生分批贷款，成功后失联。',
    region: '安徽'
  }
])
</script>
